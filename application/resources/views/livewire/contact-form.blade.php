<div class="">
    @if (session()->has('message'))
        <div id="successMessage"  class="flex justify-center items-center">
            <div
                class=" w-1/2  py-3 px-5 mb-4 bg-green-100 text-green-900 text-sm rounded-md border border-green-200 flex items-center justify-between"
                role="alert">
